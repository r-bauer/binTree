...
PRIVATE SLINK CreateNode(SBINTREE *, void *);
...
/*
    ...
    Parametros:   
          ponteiros p/ a funcoesh especificas da arvoreh
              ...
              int   (*fTraversal)( void *, void *, int) -> percorre a arvore
...
*/
PRIVATE void InOrder(void *pOut, SBINTREE *BT, SLINK slk, int iLevel)
{
    if (slk) {
...
/*
    ...
    Descricao:
              ...
              apontada por fTraversal para tratar o noh.
*/
PRIVATE void PreOrder(void *pOut, SBINTREE *BT, SLINK slk, int iLevel)
{
    if (slk) {
        Traversal(pOut, slk, iLevel);
...
/*
    ...
    Descricao:
              ...
              apontada por fTraversal para tratar o noh.
*/
PRIVATE void PostOrder(void *pOut, SBINTREE *BT, SLINK slk, int iLevel)
{
    if (slk) {
...
*/
PRIVATE void DelTree( SBINTREE *BT, SLINK slk )
{
    if (slk) {
...
/*
    ...
    Descricao:
              ...
              ramificacaoh.
*/
PRIVATE void PrintTree(FILE *fLog, SBINTREE *BT, SLINK slk, int iLevel) 
{
    if (slk) 
    { 
        ...
        // imprime o noh atual
        {
            ...
            if (pDraw)
            {
                ...
                {
                    // Path = RRRRLRRRL
                    // sequencia RL(direita/esquerda) OU LF(esquerda/direita)
