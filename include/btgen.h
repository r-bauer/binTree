...
{
//    struct tagSNODE   *right; //  ligacaoh para o noh subarvore direita
//    struct tagSNODE   *left;  //  ligacaoh para o noh subarvore esquerda
...
EXTERN SBINTREE *CreateBinTree( void *  ( * fCreateData )       ( void * ),             // criar dado
                                ...
                                // auxilio de teste
                                int     ( * fTraversal )        ( void *, void *, int));// percorre noh 
